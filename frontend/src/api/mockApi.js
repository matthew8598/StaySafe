...
let _mockAlerts = [
  {
    ...
    message: "temperature anomaly: reading above maximum threshold (35). Latest value: 38.2.",
  ...
  },
  {
    ...
    deviceId: 1,
    sensorType: "light",
    message: "light anomaly: reading above maximum threshold (5). Latest value: 41.0.",
